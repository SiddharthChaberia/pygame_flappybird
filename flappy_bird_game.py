...
game_images={}
framepersecond=32
pipeimage='pygame_flappy/images/pipe.png'
background_image='pygame_flappy/images/background.jpg'
birdplayer_image='pygame_flappy/images/bird.png'
sealevel_image='pygame_flappy/images/base.jfif'
    ...
    while True:
        ...
        for pipe in up_pipes:
            ...
            if pipeMidPos<=playerMidPos<pipeMidPos+4:
                your_score+=1
                print("Your score in {}".format(your_score))
...
if __name__=="__main__":
    ...
    game_images['scoreimages']=(
        pygame.image.load('pygame_flappy/images/zero.png').convert_alpha(),
        pygame.image.load('pygame_flappy/images/one.png').convert_alpha(),
        pygame.image.load(r'pygame_flappy/images/two.png').convert_alpha(),
        pygame.image.load(r'pygame_flappy/images/three.png').convert_alpha(),
        pygame.image.load('pygame_flappy/images/four.png').convert_alpha(),
        pygame.image.load('pygame_flappy/images/five.png').convert_alpha(),
        pygame.image.load('pygame_flappy/images/six.png').convert_alpha(),
        pygame.image.load('pygame_flappy/images/seven.png').convert_alpha(),
        pygame.image.load('pygame_flappy/images/eight.png').convert_alpha()
    )
        ...
        while True:
            for event in pygame.event.get():
                if event.type==QUIT or (event.type==KEYDOWN and event.key==K_ESCAPE):
                    ...
                    window.blit(game_images['background'], (0,0))
                    window.blit(game_images['background'], (horizontal, vertical))
                    window.blit(game_images['background'], (ground,elevation))
                    pygame.display.update()
                    framepersecond_clock.tick(framepersecond)